...
SmoothedData = BilateralFilter(Data, 2.3, 2.9)
SmoothedData2 = BilateralFilter(SmoothedData, 2.3, 2.9)
...
fig.suptitle('Real Data Time Series 3 \n Bilateral Filter - $\sigma_d = 2.3$ - $\sigma_i = 2.9 \hat{\sigma}_n$',  fontsize = 12)
...
plt.savefig('2SameBilateralRealSignal3.png')
