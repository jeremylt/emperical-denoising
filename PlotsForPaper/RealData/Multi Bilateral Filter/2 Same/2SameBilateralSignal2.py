...
SmoothedData = BilateralFilter(Data, 3.2, 1.8)
SmoothedData2 = BilateralFilter(SmoothedData, 3.2, 1.8)
...
fig.suptitle('Real Data Time Series 2 \n Bilateral Filter - $\sigma_d = 3.2$ - $\sigma_i = 1.8 \hat{\sigma}_n$',  fontsize = 12)
...
plt.savefig('2SameBilateralRealSignal2.png')
