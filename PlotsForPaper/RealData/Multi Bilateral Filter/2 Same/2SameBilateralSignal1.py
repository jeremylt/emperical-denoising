...
SmoothedData = BilateralFilter(Data, 3.6, 2.2)
SmoothedData2 = BilateralFilter(SmoothedData, 3.6, 2.2)
...
fig.suptitle('Real Data Time Series 1 \n Bilateral Filter - $\sigma_d = 3.6$ - $\sigma_i = 2.2 \hat{\sigma}_n$',  fontsize = 12)
...
plt.savefig('2SameBilateralRealSignal1.png')
