...
fig.suptitle('Real Data Time Series 1 \n First Bilateral Filter - $\sigma_d = 3.1$ - $\sigma_i = 2.0 \hat{\sigma}_n$ \n Second Bilateral Filter - $\sigma_d = 2.9$ - $\sigma_i = 2.4 \hat{\sigma}_n$',  fontsize = 12)
...
plt.savefig('2DiffBilateralRealSignal1.png')
