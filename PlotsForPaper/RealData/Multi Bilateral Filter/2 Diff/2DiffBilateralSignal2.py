...
SmoothedData = BilateralFilter(Data, 2.2, 1.7)
SmoothedData2 = BilateralFilter(SmoothedData, 3.3, 2.9)
...
fig.suptitle('Real Data Time Series 2 \n First Bilateral Filter - $\sigma_d = 2.2$ - $\sigma_i = 1.7 \hat{\sigma}_n$ \n Second Bilateral Filter - $\sigma_d = 3.3$ - $\sigma_i = 2.9 \hat{\sigma}_n$',  fontsize = 12)
...
plt.savefig('2DiffBilateralRealSignal2.png')
