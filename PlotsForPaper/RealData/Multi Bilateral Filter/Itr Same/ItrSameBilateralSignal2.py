...
SmoothedData1 = BilateralFilter(Data, 3.7, 1.9)
SmoothedData2 = BilateralFilter(SmoothedData1, 3.7, 1.9)

while np.sum((SmoothedData1 - SmoothedData2)**2) > 0.01*np.sum(SmoothedData2**2):
    SmoothedData1 = BilateralFilter(SmoothedData2, 3.7, 1.9)
    SmoothedData2 = BilateralFilter(SmoothedData1, 3.7, 1.9)
...
fig.suptitle('Real Data Time Series 2 \n Bilateral Filter - $\sigma_d = 3.7$ - $\sigma_i = 1.9 \hat{\sigma}_n$',  fontsize = 12)
...
plt.savefig('ItrSameBilateralRealSignal2.png')
