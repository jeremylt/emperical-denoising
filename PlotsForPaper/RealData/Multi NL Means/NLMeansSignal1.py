...
SmoothedDatai = NLMeansFilter(Data, 0.67, 7, 0.67)
SmoothedData = NLMeansFilter(SmoothedDatai, 0.34, 7, 0.34)
...
fig.suptitle('Real Data Time Series 1 \n First Non-Local Means Filter - $\\beta = 0.67$ - $|I| = 7$ - $T = 0.67 ( max Y_j - min Y_j ) \n Second Non-Local Means Filter$\\beta = 0.34$ - $|I| = 7$ - $T = 0.34 ( max Y_j - min Y_j )$',  fontsize = 12)
...
plt.savefig('MultiNLMeansRealSignal1.png')
