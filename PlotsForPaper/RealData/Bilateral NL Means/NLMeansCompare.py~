...
def NLMeansFilter(Data, beta):
    ...
    offset = 3
    thresh = (max(Data) - min(Data))*(2*offset + 1)*0.9
    thresh *= thresh
    var = varest(Data)
...
# Plot Time Series 1
Data1i = BilateralFilter(Data1, 2.5, 1.8)
SmoothedData = NLMeansFilter(Data1i, 0.5)

axarr[0].set_title('Bilateral Non-Local Means Filter - $\sigma_d$ = 2.5, $\sigma_i$ = 1.8 $\hat{\sigma}_n$, $\\beta$ = 0.5, $|I|$ = 7, $T$ = $0.9 ( max Y_j - min Y_j)$')
...
# Plot Time Series 2
Data2i = BilateralFilter(Data2, 2.5, 1.8)
SmoothedData = NLMeansFilter(Data2i, 0.5)

axarr[1].set_title('Bilateral Non-Local Means Filter - $\sigma_d$ = 2.5, $\sigma_i$ = 1.8 $\hat{\sigma}_n$, $\\beta$ = 0.5, $|I|$ = 7, $T$ = $0.9 ( max Y_j - min Y_j)$')
...
# Plot Time Series 3
Data3i = BilateralFilter(Data3, 2.5, 1.8)
SmoothedData = NLMeansFilter(Data3i, 0.5)

axarr[2].set_title('Bilateral Non-Local Means Filter - $\sigma_d$ = 2.5, $\sigma_i$ = 1.8 $\hat{\sigma}_n$, $\\beta$ = 0.5, $|I|$ = 7, $T$ = $0.9 ( max Y_j - min Y_j)$')
...
fig.savefig('BilateralNLMeansRealCompare.png')
plt.show()
